...
#                 time_taken = int(timer_duration - time_left)
...
#             screen.blit(info_font.render(f"Level: {current_level}", True, (0, 0, 0)), (box_x + 10, box_y + 10))
#             screen.blit(info_font.render(f"Target: {level_data['target_score']}", True, (0, 0, 0)), (box_x + 10, box_y + 35))
#             screen.blit(info_font.render(f"Time Left: {time_left}", True, (0, 0, 0)), (box_x + 10, box_y + 60))
#             screen.blit(info_font.render(f"Score: {score}", True, (0, 0, 0)), (box_x + 10, box_y + 85))
